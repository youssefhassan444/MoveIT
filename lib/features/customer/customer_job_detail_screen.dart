                ...
                children: [
                  ...
                  MarkerLayer(
                    markers: [
                      ...
                      if (tracking != null)
                        Marker(
                          point: LatLng(tracking.driverLatLng.latitude,
                              ...
                              Row(
                                ...
                                children: [
                                  IconButton(
                                    onPressed: () {
                                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                        content: Text('Calling ${driver.displayName}...'),
                                      ),);
                                    },
                                    icon: const Icon(Icons.phone, color: AppTheme.brandSuccess),
                                    tooltip: 'Call Driver',
                                  ),
                                  IconButton(
                                    onPressed: () {
                                    ...
                                    icon: const Icon(Icons.chat, color: AppTheme.brandSkyBlue),
                                  ...
                                  IconButton(
                                    ...
                                    icon: const Icon(Icons.report, color: AppTheme.brandError),
